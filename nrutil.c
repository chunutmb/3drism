...
__inline double DMAX(double a, double b)
{
  return a > b ? a : b;
}
...
__inline double DMIN(double a, double b)
{
  return a < b ? a : b;
}
...
__inline float FMAX(float a, float b)
{
  return a > b ? a : b;
}
...
__inline float FMIN(float a, float b)
{
  return a < b ? a : b;
}
...
__inline long LMAX(long a, long b)
{
  return a > b ? a : b;
}
...
__inline long LMIN(long a, long b)
{
  return a < b ? a : b;
}
